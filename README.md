...
- **Rapports** : 6 rapports (État des Autorisations — une ligne par produit avec N° ONU/CAS/CEE et désignation chimique, Détail d'une Autorisation, Historique des Achats, Produits les Plus Acquis, Performance par Département, Déclaration Mensuelle par Autorisation), export PDF et CSV. La Déclaration Mensuelle reprend les champs d'identification chimique du système VBA (Désignation technique, N° ONU, N° CAS, N° CEE, Désignation chimique, N° Autorisation) et affiche, pour le mois choisi, les mouvements (acquis/utilisé sur le mois) ainsi que la quantité acquise cumulée, le stock et le reste à acquérir.
...
- **Stock, Achats, Utilisations par autorisation** : les pages Achats et Utilisations proposent un filtre par autorisation (en plus de la vue globale) ; la page Stock permet de basculer entre la vue agrégée (Σ toutes autorisations, par produit/département, avec seuils minimum configurables par l'Admin et alerte Faible/Critique) et une vue par autorisation précise (quantités autorisée/acquise/utilisée/restante et état par produit)
- **Saisie des produits** : vue tableau (type tableur, par défaut, pleine largeur d'écran) ou vue cartes (secondaire, au choix) pour la création de Canevas et d'Autorisations
